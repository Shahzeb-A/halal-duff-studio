...
try: import config as _C; _MODELS = _C.MODELS
except Exception: _MODELS = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "models")
os.makedirs(_MODELS, exist_ok=True)

inp, outdir, model = sys.argv[1], sys.argv[2], sys.argv[3]
os.makedirs(outdir, exist_ok=True)
sep = Separator(output_dir=outdir, output_format="WAV", model_file_dir=_MODELS)  # cache weights in our own models/ dir
